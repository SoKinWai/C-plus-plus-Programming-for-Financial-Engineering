...
//The function Length() must determine the length of the string. Give Length()the address of the array as argument.
...
/* Length() function should be similar to the built-in strlen() function*/
